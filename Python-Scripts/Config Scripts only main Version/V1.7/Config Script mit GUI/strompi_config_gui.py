...
def Set_Alarm_hour_off(sp3_alarm_hour_off):
    ...
    if sp3_alarm_hour_off.isdigit():
        ...
        if (sp3_alarm_hour_off2 < 61) and (sp3_alarm_hour_off2 >= 0):
            serial_port.write(str.encode('set-config ' + '9 ' + str(sp3_alarm_hour_off)))
        else:
...
def Set_Alarm_min_off(sp3_alarm_min_off):
    ...
    if sp3_alarm_min_off.isdigit():
        ...
        if (sp3_alarm_min_off2 < 61) and (sp3_alarm_min_off2 >= 0):
            serial_port.write(str.encode('set-config ' + '8 ' + str(sp3_alarm_min_off)))
        else:
            ShutdownTimeError = 1 #("You can only use Digits between 0 and 65535 for the shutdown timer")
    else:
        ShutdownTimeError = 1 #("You can only use Digits between 0 and 65535 for the shutdown timer")
...
def Upload_to_StromPi():
    ...
    Set_Alarm_Mode(sp3_alarm_mode) #2-4
...
def Refresh_Status():
    ...
    tkAlarmPoweroffmin.set(str(sp3_alarm_min, 'utf-8').rstrip('\n').zfill(2) + ' Minutes')
    tkAlarmPoweroffhour.set(str(sp3_alarm_hour, 'utf-8').rstrip('\n').zfill(2) + ' Hours')
    tkAlarmPoweroffmonth.set(str(sp3_alarm_month, 'utf-8').rstrip('\n').zfill(2))
    tkAlarmPoweroffweekday.set(' WakeUp-Alarm: ' + weekday_converter(int(sp3_alarm_weekday)))
    tkAlarmPoweroffday.set(str(sp3_alarm_day, 'utf-8').rstrip('\n').zfill(2) + ' Day')
    tkAlarmhouroff.set(str(sp3_alarm_hour_off, 'utf-8').rstrip('\n').zfill(2) + ' Hours')
    tkAlarmminoff.set(str(sp3_alarm_min_off, 'utf-8').rstrip('\n').zfill(2) + ' Minutes')
...
fenster.minsize(width=500, height=250)
fenster.maxsize(width=3000, height=3000)
...
Alarm_ModeChoices = ['1 = Daily time alarm', '2 = Date controlled time alarm', '3 = Weekly time alarm']
...
SetClockFrame1.grid(row = 1, column = 1, columnspan=3, rowspan=1, padx=30, pady=20, sticky=NE)
EnableDisableFrame = LabelFrame(mainframe, text="Options Without Timesettings:", fg="snow", bg="#275c6b")
EnableDisableFrame.grid(row = 1, column = 0, columnspan=1, rowspan=1, sticky=W, padx=30, pady=20)
SetShutdownFrame = LabelFrame(mainframe, text="Shutdown Timer", fg="snow", bg="#275c6b")
SetShutdownFrame.grid(row = 2, column = 0, columnspan=2, rowspan=1, sticky=W, padx=30, pady=20)
PowerOnButtonFrame = LabelFrame(mainframe, text="PowerOnButton", fg="snow", bg="#275c6b")
PowerOnButtonFrame.grid(row = 2, column = 2, columnspan=2, rowspan=1, sticky=W, padx=30, pady=20)
IntervalAlarmFrame = LabelFrame(mainframe, text="Interval Timer", fg="snow", bg="#275c6b")
IntervalAlarmFrame.grid(row = 3, column = 0, columnspan=3, rowspan=1, sticky=W, padx=30, pady=20)
AlarmModeFrame = LabelFrame(mainframe, text="Alarm Modes", fg="snow", bg="#275c6b")
AlarmModeFrame.grid(row = 4, column = 0, columnspan=4, rowspan=1, sticky=W, padx=30, pady=20)
#Create GUI Objects
#--------------------------------------------------------------------------------------------------------------
...
alarmPoweroffhourlbl = Label(AlarmModeFrame, text="Choose Power-Off Hours:", fg="snow", bg="#275c6b").grid(row = 18, column = 2, columnspan=1, rowspan=1)
alarmPoweroffhourEntry = Entry(AlarmModeFrame, textvariable=tkAlarmPoweroffhour)
alarmPoweroffhourEntry.grid(row = 19, column = 2, columnspan=1, rowspan=1)
...
alarmPoweroffdaylbl = Label(AlarmModeFrame, text="Choose Power-Off Day:", fg="snow", bg="#275c6b").grid(row = 14, column = 2, columnspan=1, rowspan=1)
alarmPoweroffdayEntry = Entry(AlarmModeFrame, textvariable=tkAlarmPoweroffday)
alarmPoweroffdayEntry.grid(row = 15, column = 2, columnspan=1, rowspan=1)
...
AlarmPoweroffweekdaylbl = Label(AlarmModeFrame, text="Choose Power-Off Weekday:", fg="snow", bg="#275c6b").grid(row = 14, column = 1, columnspan=1, rowspan=1, sticky=W)
...
AlarmPoweroffmonthlbl = Label(AlarmModeFrame, text="Choose Power-Off Month:", fg="snow", bg="#275c6b").grid(row = 14, column = 3, columnspan=1, rowspan=1)
AlarmPoweroffmonthpopupMenu.grid(row = 15, column =3, columnspan=1, rowspan=1)
...
WakeUpHourlbl = Label(AlarmModeFrame, text="Setting WakeUp-Alarm Hour:", fg="snow", bg="#275c6b").grid(row = 16, column = 2, columnspan=1, rowspan=1)
WakeUpHourEntry = Entry(AlarmModeFrame, textvariable=tkAlarmhouroff)
WakeUpHourEntry.grid(row = 17, column = 2, columnspan=1, rowspan=1)
...
Alarmminofflbl = Label(IntervalAlarmFrame, text="Interval Off-Time in minutes:", fg="snow", bg="#275c6b").grid(row = 12, column = 2, columnspan=1, rowspan=1)
AlarmminoffEntry = Entry(IntervalAlarmFrame, textvariable=tkIntervalAlarmOffTime)
AlarmminoffEntry.grid(row = 13, column = 2, columnspan=1, rowspan=1)
...
#SetClockH
SetClockHlbl = Label(SetClockFrame1, text="Set the Hours:", fg="snow", bg="#275c6b").grid(row = 0, column = 3, columnspan=1, rowspan=1)
SetClockHEntry = Entry(SetClockFrame1, textvariable=tkSetClockH)
SetClockHEntry.grid(row = 1, column = 3, columnspan=1, rowspan=1)
...
#SetClockM
SetClockMlbl = Label(SetClockFrame1, text="Set the Minutes:", fg="snow", bg="#275c6b").grid(row = 0, column = 4, columnspan=1, rowspan=1)
SetClockMEntry = Entry(SetClockFrame1, textvariable=tkSetClockM)
SetClockMEntry.grid(row = 1, column = 4, columnspan=1, rowspan=1)
...
SetDateMlbl = Label(SetClockFrame1, text="Set the Month:", fg="snow", bg="#275c6b").grid(row = 4, column = 3, columnspan=1, rowspan=1)
SetDateMpopupMenu.grid(row = 5, column =3, columnspan=1, rowspan=1)
#SetDateWD
SetDateWDpopupMenu = OptionMenu(SetClockFrame1, tkSetDateWD, *Day_Choices)
SetDateWDpopupMenu.configure(background="snow")
SetDateWDlbl = Label(SetClockFrame1, text="Set The Weekday:", fg="snow", bg="#275c6b").grid(row = 4, column = 4, columnspan=1, rowspan=1)
SetDateWDpopupMenu.grid(row = 5, column =4, columnspan=1, rowspan=1)
#SetDateD
SetDateDlbl = Label(SetClockFrame1, text="Set the Days:", fg="snow", bg="#275c6b").grid(row = 2, column = 3, columnspan=1, rowspan=1)
SetDateDEntry = Entry(SetClockFrame1, textvariable=tkSetDateD)
SetDateDEntry.grid(row = 3, column = 3, columnspan=1, rowspan=1)
...
#SetDateD
SetDateYstr = 0 
SetDateYlbl = Label(SetClockFrame1, text="Set the Year:", fg="snow", bg="#275c6b").grid(row = 2, column = 4, columnspan=1, rowspan=1)
SetDateYEntry = Entry(SetClockFrame1, textvariable=tkSetDateY)
SetDateYEntry.grid(row = 3, column = 4, columnspan=1, rowspan=1)
